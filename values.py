...
BIN_DIR_NAME = 'bin'
SOFT_DIR_NAME = 'soft'
#GIT_DIR_NAME = r'\soft\PortableGit'
...
UPDATE_GIT_PATH = os.path.join(os.getcwd(), BIN_DIR_NAME, 'update')
#GIT_DIR_PATH = os.path.join(GIT_DIR_NAME, GIT_CMD_FILE)
