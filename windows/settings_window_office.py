...
class Ui_Client_settings(object):
    def setupUi(self, Client_settings):
        ...
        self.et_name.setGeometry(QtCore.QRect(110, 110, 121, 21))
        self.et_name.setObjectName("et_name")
        self.btn_add_subgroup = QtWidgets.QPushButton(self.centralwidget)
        self.btn_add_subgroup.setGeometry(QtCore.QRect(210, 67, 22, 23))
        ...
        self.cb_subgroup.setGeometry(QtCore.QRect(110, 68, 91, 22))
